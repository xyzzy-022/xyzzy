...
static void MD5Transform (u_int32_t [4], const u_char [64]);
...
static void
Encode (u_char *output, u_int32_t *input, u_int len)
{
  u_int i, j;
...
static void
Decode (u_int32_t *output, const u_char *input, u_int len)
{
  u_int i, j;
